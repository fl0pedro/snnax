...
lin_layer_ip_size = linear_layer_input_size([32, 32], 32, [7, 7, 7, 7, 7], [2, 1, 1, 1, 1], [0, 0, 3, 3, 0])
...
model = snn.Sequential(
    ...
    # 32x7x7
    snn.ResNetBlock(layer_order=['c', 'c'], layer_params=[[32, 32, 7, 1, 3], [32, 32, 7, 1, 3]], stateful_layer_type='SigmaDelta', key=key4),
